...
async function getCurrentUser() {
  ...
  const query = `
  query FindCurrentUser($id: UuidFilter = {}) {
  findFirstUsers(where: {id: $id}) {
    first_name
    email
    id
    last_name
  ...
  try {
    const currentUser = await fetchGraphQL<any>(query, {id:userId})
    return currentUser.data.findFirstUsers;
  } catch (error) {
