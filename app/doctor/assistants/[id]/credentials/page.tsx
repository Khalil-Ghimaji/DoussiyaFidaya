...
export default async function AssistantCredentialsPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="container py-8">
      <div className="mx-auto max-w-2xl">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Identifiants de {assistant.name}</CardTitle>
            <CardDescription>Régénérez les identifiants de connexion pour cet assistant</CardDescription>
          </CardHeader>
          <CardContent>
            <CredentialsForm assistantId={params.id} />
          </CardContent>
        </Card>
      </div>
    </div>
