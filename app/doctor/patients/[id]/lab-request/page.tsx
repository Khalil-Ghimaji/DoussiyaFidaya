...
export default async function PatientLabRequestPage({ params }: { params: { id: string } }) {
    ...
    <div className="container py-8">
      ...
      <div className="mb-6">
        <h1 className="text-3xl font-bold tracking-tight">
          Demande d'analyses - {patient.firstName} {patient.lastName}
        </h1>
        <p className="text-muted-foreground">Créez une nouvelle demande d'analyses pour ce patient</p>
      </div>
      ...
      >
        <LabRequestForm patient={patient} />
      </Suspense>
    </div>
  )
}
