...
import {createRdvConsultationAction} from "@/app/doctor/appointments/[id]/consultation/actions";


type RdvConsultationFormProps = {
  patient: PatientExtended
  rdvId: string // Optional, if this form is used for a specific appointment
}
...
export function RdvConsultationForm({ patient,rdvId }: RdvConsultationFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await createRdvConsultationAction(patient.id,rdvId, formDataToSubmit);
